...
p.nominalBounds = new cjs.Rectangle(0,0,107,72);
...
p.nominalBounds = new cjs.Rectangle(0,0,409,262);
...
p.nominalBounds = new cjs.Rectangle(0,0,81,45);
...
(lib.RedX = function() {
	...
	// shadlow
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("ABjDqIhjidIhjCdIhiAAICWjpIiVjpIBhAAIBjCeIBkieIBiAAIiWDpICVDpg");
	this.shape.setTransform(0,0.3);

	this.addChild(this.shape,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-19.8,-23.1,39.7,46.8);
...
(lib.Arrow4 = function() {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgPAAIgiggIBiAgIhiAhg");
...
(lib.printer = function() {
	...
	// shading
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(0,0,0,0.153)","rgba(0,0,0,0.353)"],[0,1],-3.2,3.2,4.6,-4.6).s().p("Ag8AwIB5h7IAAAbIh5B8g");
	this.shape.setTransform(100,-33.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["rgba(255,255,255,0.251)","rgba(0,0,0,0.153)"],[0,1],-2.9,3.1,6.5,-6.3).s().p("Ag+gYID8hMIh7B8IkBBNg");
	this.shape_1.setTransform(87.1,-31);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("rgba(0,0,0,0.012)").s().p("AiAAYIEBhLIAAAcIkBBLg");
	this.shape_2.setTransform(80.9,-23.4);

	// paper tray
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#237AA7").s().p("Ai+BXICAh9ID8hLIAAAbIh7B8IkBBMg");
	this.shape_3.setTransform(87.1,-29.6);

	// z box_flat narrow divided
	this.instance = new lib.Bitmap9();
	this.instance.setTransform(0,-44.8);

	this.addChild(this.instance,this.shape_3,this.shape_2,this.shape_1,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,-44.8,106.2,45);
...
(lib.computerlaptop = function() {
	...
	this.instance.setTransform(0,-71.9);
...
(lib.computer = function() {
	...
	this.addChild(this.instance,this.shape_16,this.shape_15,this.shape_14,this.shape_13,this.shape_12,this.shape_11,this.shape_10,this.shape_9,this.shape_8,this.shape_7,this.shape_6,this.shape_5,this.shape_4,this.shape_3,this.shape_2,this.shape_1,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,-74,90,74.2);
...
(lib.animation03 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(392,253.2,0.75,0.75,0,0,0,0,0.3);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(84).to({_off:false},0).to({alpha:1},7).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(52).to({_off:false},0).to({x:392.7,y:253.3},32).wait(18));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(52).to({_off:false},0).to({x:249.7,y:298.3},32).wait(18));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(52).to({_off:false},0).to({x:326,y:289.7},32).wait(18));

	// Red x
	this.instance_4 = new lib.RedX();
	this.instance_4.setTransform(151.5,291.2,0.75,0.75,0,0,0,0,0.3);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(84).to({_off:false},0).to({alpha:1},7).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(52).to({_off:false},0).to({x:151.7,y:290.3},32).wait(18));

	// Packet
	this.instance_6 = new lib.envelopeclosedstatic();
	this.instance_6.setTransform(58.8,257.7,0.45,0.45,0,0,0,1.6,0.1);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(12).to({_off:false},0).to({alpha:0.988},12).to({regX:1.5,x:246.3,y:152.2},28).to({_off:true},1).wait(49));

	// Arrow5
	this.instance_7 = new lib.Arrow();
	this.instance_7.setTransform(292,176.6,1.797,1.797,37.1,0,0,5,-0.1);
	this.instance_7._off = true;

	this.instance_8 = new lib.Arrow4();
	this.instance_8.setTransform(366.8,235.9,1.797,1.797,40.6,0,0,5.1,0);
	this.instance_8.alpha = 0;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_7}]},56).to({state:[{t:this.instance_7}]},8).to({state:[{t:this.instance_8}]},11).to({state:[]},1).wait(26));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(56).to({_off:false},0).to({regX:5.1,regY:0,rotation:40.6,x:366.8,y:235.9},8).to({_off:true,alpha:0},11).wait(27));
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#F68026").ss(3,1,1).p("Ai0iMIFqEZ");
	this.shape_2.setTransform(291.4,176.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#F68026").ss(3,1,1).p("AjhivIHEFf");
	this.shape_3.setTransform(295.9,180);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#F68026").ss(3,1,1).p("AkOjSIIdGl");
	this.shape_4.setTransform(300.5,183.5);
	...
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#F68026").ss(3,1,1).p("AlokYILRIx");
	...
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("rgba(246,128,38,0.91)").ss(3,1,1).p("AnClfIOFK/");
	this.shape_9.setTransform(318.5,197.5);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("rgba(246,128,38,0.82)").ss(3,1,1).p("AnClfIOFK/");
	this.shape_10.setTransform(318.5,197.5);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("rgba(246,128,38,0.725)").ss(3,1,1).p("AnClfIOFK/");
	this.shape_11.setTransform(318.5,197.5);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("rgba(246,128,38,0.635)").ss(3,1,1).p("AnClfIOFK/");
	this.shape_12.setTransform(318.5,197.5);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("rgba(246,128,38,0.545)").ss(3,1,1).p("AnClfIOFK/");
	this.shape_13.setTransform(318.5,197.5);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("rgba(246,128,38,0.455)").ss(3,1,1).p("AnClfIOFK/");
	this.shape_14.setTransform(318.5,197.5);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("rgba(246,128,38,0.365)").ss(3,1,1).p("AnClfIOFK/");
	this.shape_15.setTransform(318.5,197.5);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("rgba(246,128,38,0.275)").ss(3,1,1).p("AnClfIOFK/");
	this.shape_16.setTransform(318.5,197.5);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f().s("rgba(246,128,38,0.18)").ss(3,1,1).p("AnClfIOFK/");
	this.shape_17.setTransform(318.5,197.5);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f().s("rgba(246,128,38,0.09)").ss(3,1,1).p("AnClfIOFK/");
	...
	this.instance_9.setTransform(272.7,194.1,1.797,1.797,66.8,0,0,5,0);
	this.instance_9._off = true;

	this.instance_10 = new lib.Arrow4();
	this.instance_10.setTransform(304.2,267.2,1.797,1.797,66.8,0,0,5,0);
	this.instance_10.alpha = 0;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_9}]},56).to({state:[{t:this.instance_9}]},8).to({state:[{t:this.instance_10}]},11).to({state:[]},1).wait(26));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(56).to({_off:false},0).to({x:304.2,y:267.2},8).to({_off:true,alpha:0},11).wait(27));

	// Arrowline4
	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f().s("#F68026").ss(3,1,1).p("AgshqIBZDV");
	this.shape_20.setTransform(267.9,183);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f().s("#F68026").ss(3,1,1).p("Ag/iYIB/Ew");
	this.shape_21.setTransform(269.9,187.6);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f().s("#F68026").ss(3,1,1).p("AhTjFICnGL");
	this.shape_22.setTransform(271.8,192.1);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f().s("#F68026").ss(3,1,1).p("AhmjzIDNHn");
	this.shape_23.setTransform(273.8,196.7);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f().s("#F68026").ss(3,1,1).p("Ah6khID1JD");
	this.shape_24.setTransform(275.7,201.3);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f().s("#F68026").ss(3,1,1).p("AiNlOIEbKd");
	this.shape_25.setTransform(277.7,205.8);

	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f().s("#F68026").ss(3,1,1).p("Aihl8IFDL5");
	this.shape_26.setTransform(279.6,210.4);

	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f().s("#F68026").ss(3,1,1).p("Ai0mpIFpNT");
	this.shape_27.setTransform(281.6,214.9);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f().s("#F68026").ss(3,1,1).p("AjInXIGROv");
	this.shape_28.setTransform(283.5,219.5);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f().s("rgba(246,128,38,0.91)").ss(3,1,1).p("AjInXIGROv");
	this.shape_29.setTransform(283.5,219.5);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f().s("rgba(246,128,38,0.82)").ss(3,1,1).p("AjInXIGROv");
	this.shape_30.setTransform(283.5,219.5);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f().s("rgba(246,128,38,0.725)").ss(3,1,1).p("AjInXIGROv");
	this.shape_31.setTransform(283.5,219.5);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f().s("rgba(246,128,38,0.635)").ss(3,1,1).p("AjInXIGROv");
	this.shape_32.setTransform(283.5,219.5);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f().s("rgba(246,128,38,0.545)").ss(3,1,1).p("AjInXIGROv");
	this.shape_33.setTransform(283.5,219.5);

	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f().s("rgba(246,128,38,0.455)").ss(3,1,1).p("AjInXIGROv");
	this.shape_34.setTransform(283.5,219.5);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f().s("rgba(246,128,38,0.365)").ss(3,1,1).p("AjInXIGROv");
	this.shape_35.setTransform(283.5,219.5);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f().s("rgba(246,128,38,0.275)").ss(3,1,1).p("AjInXIGROv");
	this.shape_36.setTransform(283.5,219.5);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f().s("rgba(246,128,38,0.18)").ss(3,1,1).p("AjInXIGROv");
	this.shape_37.setTransform(283.5,219.5);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f().s("rgba(246,128,38,0.09)").ss(3,1,1).p("AjInXIGROv");
	this.shape_38.setTransform(283.5,219.5);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f().s("rgba(246,128,38,0)").ss(3,1,1).p("AjInXIGROv");
	...
	this.instance_11.setTransform(246,198.8,1.797,1.797,86.9,0,0,5,0);
	this.instance_11._off = true;

	this.instance_12 = new lib.Arrow4();
	this.instance_12.setTransform(250.8,274.9,1.797,1.797,86.9,0,0,5,0);
	this.instance_12.alpha = 0;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_11}]},56).to({state:[{t:this.instance_11}]},8).to({state:[{t:this.instance_12}]},11).to({state:[]},1).wait(26));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(56).to({_off:false},0).to({x:250.8,y:274.9},8).to({_off:true,alpha:0},11).wait(27));
	...
	this.shape_45.graphics.f().s("#F68026").ss(3,1,1).p("AgXlvIAvLg");
	this.shape_45.setTransform(246.4,209.5);
	...
	this.shape_47.graphics.f().s("#F68026").ss(3,1,1).p("AgenNIA8Ob");
	this.shape_47.setTransform(247.1,218.8);
	...
	this.shape_49.graphics.f().s("rgba(246,128,38,0.91)").ss(3,1,1).p("Aghn7IBDP3");
	this.shape_49.setTransform(247.4,223.4);

	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f().s("rgba(246,128,38,0.82)").ss(3,1,1).p("Aghn7IBDP3");
	this.shape_50.setTransform(247.4,223.4);

	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f().s("rgba(246,128,38,0.725)").ss(3,1,1).p("Aghn7IBDP3");
	this.shape_51.setTransform(247.4,223.4);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f().s("rgba(246,128,38,0.635)").ss(3,1,1).p("Aghn7IBDP3");
	this.shape_52.setTransform(247.4,223.4);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f().s("rgba(246,128,38,0.545)").ss(3,1,1).p("Aghn7IBDP3");
	this.shape_53.setTransform(247.4,223.4);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f().s("rgba(246,128,38,0.455)").ss(3,1,1).p("Aghn7IBDP3");
	this.shape_54.setTransform(247.4,223.4);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f().s("rgba(246,128,38,0.365)").ss(3,1,1).p("Aghn7IBDP3");
	this.shape_55.setTransform(247.4,223.4);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f().s("rgba(246,128,38,0.275)").ss(3,1,1).p("Aghn7IBDP3");
	this.shape_56.setTransform(247.4,223.4);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f().s("rgba(246,128,38,0.18)").ss(3,1,1).p("Aghn7IBDP3");
	this.shape_57.setTransform(247.4,223.4);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f().s("rgba(246,128,38,0.09)").ss(3,1,1).p("Aghn7IBDP3");
	...
	this.instance_13.setTransform(217.8,191.1,1.797,1.797,0,-54.8,125.2,5,0);
	this.instance_13._off = true;

	this.instance_14 = new lib.Arrow4();
	this.instance_14.setTransform(165.9,265.8,1.797,1.797,0,-54.3,125.7,5.1,0);
	this.instance_14.alpha = 0;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_13}]},56).to({state:[{t:this.instance_13}]},8).to({state:[{t:this.instance_14}]},11).to({state:[]},1).wait(26));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(56).to({_off:false},0).to({regX:5.1,skewX:-54.3,skewY:125.7,x:165.9,y:265.8},8).to({_off:true,alpha:0},11).wait(27));

	// Arrowline2
	this.shape_60 = new cjs.Shape();
	this.shape_60.graphics.f().s("#F68026").ss(3,1,1).p("ABCheIiDC9");
	this.shape_60.setTransform(225.1,181.3);

	this.shape_61 = new cjs.Shape();
	this.shape_61.graphics.f().s("#F68026").ss(3,1,1).p("AhiCOIDFka");
	this.shape_61.setTransform(221.9,186);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f().s("#F68026").ss(3,1,1).p("AiCC8IEGl3");
	this.shape_62.setTransform(218.7,190.6);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f().s("#F68026").ss(3,1,1).p("AijDrIFHnV");
	this.shape_63.setTransform(215.4,195.2);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f().s("#F68026").ss(3,1,1).p("AjEEaIGJoy");
	this.shape_64.setTransform(212.3,199.9);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f().s("#F68026").ss(3,1,1).p("AjlFIIHLqP");
	this.shape_65.setTransform(209,204.6);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f().s("#F68026").ss(3,1,1).p("AkGF3IIMrt");
	this.shape_66.setTransform(205.8,209.2);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f().s("#F68026").ss(3,1,1).p("AkmGlIJNtJ");
	this.shape_67.setTransform(202.6,213.8);

	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f().s("#F68026").ss(3,1,1).p("AFInTIqPOn");
	this.shape_68.setTransform(199.4,218.5);

	this.shape_69 = new cjs.Shape();
	this.shape_69.graphics.f().s("rgba(246,128,38,0.91)").ss(3,1,1).p("AlHHUIKPun");
	this.shape_69.setTransform(199.4,218.5);

	this.shape_70 = new cjs.Shape();
	this.shape_70.graphics.f().s("rgba(246,128,38,0.82)").ss(3,1,1).p("AlHHUIKPun");
	this.shape_70.setTransform(199.4,218.5);

	this.shape_71 = new cjs.Shape();
	this.shape_71.graphics.f().s("rgba(246,128,38,0.725)").ss(3,1,1).p("AlHHUIKPun");
	this.shape_71.setTransform(199.4,218.5);

	this.shape_72 = new cjs.Shape();
	this.shape_72.graphics.f().s("rgba(246,128,38,0.635)").ss(3,1,1).p("AlHHUIKPun");
	this.shape_72.setTransform(199.4,218.5);

	this.shape_73 = new cjs.Shape();
	this.shape_73.graphics.f().s("rgba(246,128,38,0.545)").ss(3,1,1).p("AlHHUIKPun");
	this.shape_73.setTransform(199.4,218.5);

	this.shape_74 = new cjs.Shape();
	this.shape_74.graphics.f().s("rgba(246,128,38,0.455)").ss(3,1,1).p("AlHHUIKPun");
	this.shape_74.setTransform(199.4,218.5);

	this.shape_75 = new cjs.Shape();
	this.shape_75.graphics.f().s("rgba(246,128,38,0.365)").ss(3,1,1).p("AlHHUIKPun");
	this.shape_75.setTransform(199.4,218.5);

	this.shape_76 = new cjs.Shape();
	this.shape_76.graphics.f().s("rgba(246,128,38,0.275)").ss(3,1,1).p("AlHHUIKPun");
	this.shape_76.setTransform(199.4,218.5);

	this.shape_77 = new cjs.Shape();
	this.shape_77.graphics.f().s("rgba(246,128,38,0.18)").ss(3,1,1).p("AlHHUIKPun");
	this.shape_77.setTransform(199.4,218.5);

	this.shape_78 = new cjs.Shape();
	this.shape_78.graphics.f().s("rgba(246,128,38,0.09)").ss(3,1,1).p("AlHHUIKPun");
	this.shape_78.setTransform(199.4,218.5);

	this.shape_79 = new cjs.Shape();
	this.shape_79.graphics.f().s("rgba(246,128,38,0)").ss(3,1,1).p("AFInTIqPOn");
	this.shape_79.setTransform(199.4,218.5);
	...
	this.instance_15.setTransform(97.8,231.2,1.8,1.8,-30,0,0,5,0);
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(24).to({_off:false},0).to({x:201.3,y:176.3},14).to({alpha:0},14).wait(50));
	...
	this.instance_16.setTransform(31.3,66.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(102));

	// computer glow
	this.instance_17 = new lib.computer();
	this.instance_17.setTransform(61.5,265.8,0.63,0.63,0,0,0,44.7,-36.9);
	this.instance_17.shadow = new cjs.Shadow("rgba(255,102,0,1)",0,0,0);
	this.instance_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(7).to({_off:false},0).wait(95));

	// Computers
	this.instance_18 = new lib.computer();
	this.instance_18.setTransform(152.8,297.8,0.628,0.628,0,0,0,44.6,-36.9);
	this.instance_18._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(84).to({_off:false},0).wait(18));

	// Laptop2
	this.instance_19 = new lib.computerlaptop();
	this.instance_19.setTransform(318.6,296.4,0.628,0.628,0,0,0,53.6,-36.1);
	this.instance_19.shadow = new cjs.Shadow("rgba(242,98,0,1)",0,0,0);
	this.instance_19._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(84).to({_off:false},0).wait(18));

	// Laptop
	this.instance_20 = new lib.computerlaptop();
	this.instance_20.setTransform(242.6,305.4,0.628,0.628,0,0,0,53.6,-36.1);
	this.instance_20.shadow = new cjs.Shadow("rgba(242,98,0,1)",0,0,0);
	this.instance_20._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(84).to({_off:false},0).wait(18));

	// Printer
	this.instance_21 = new lib.printer();
	this.instance_21.setTransform(401.1,251.9,0.628,0.628,0,0,0,53,-22.4);
	this.instance_21._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(84).to({_off:false},0).wait(18));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(31.3,66.4,409,262);
...
(lib.animation02 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(52).to({_off:false},0).to({x:247.2,y:104},23).to({y:101.9},1).to({x:247.3,y:99.8},1).to({y:97.7},1).to({x:247.4,y:95.6},1).to({x:247.5,y:85.1},5).wait(18));
	...
	this.instance_4.setTransform(244.7,119.3,1.797,1.797,-90.9,0,0,5,0);
	this.instance_4._off = true;

	this.instance_5 = new lib.Arrow4();
	this.instance_5.setTransform(245.7,111.9,1.797,1.797,-90.9,0,0,5,0);
	this.instance_5.alpha = 0;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_4}]},56).to({state:[{t:this.instance_4}]},8).to({state:[{t:this.instance_5}]},11).to({state:[]},1).wait(26));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(56).to({_off:false},0).to({y:107.9},8).to({_off:true,x:245.7,y:111.9,alpha:0},11).wait(27));
	...
	this.instance_6.setTransform(227.5,193.1,1.797,1.797,111.8,0,0,5,0);
	this.instance_6._off = true;

	this.instance_7 = new lib.Arrow4();
	this.instance_7.setTransform(191.8,281.4,1.797,1.797,111.8,0,0,5,0);
	this.instance_7._off = true;
	//this.instance_7.filters = [new cjs.ColorFilter(0, 0, 0, 1, 246, 128, 38, 0)];
	this.instance_7.cache(-2,-5,14,11);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(56).to({_off:false},0).to({_off:true,x:191.8,y:281.4},8).wait(38));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(56).to({_off:false},8).to({alpha:0},11).to({_off:true},1).wait(26));
	...
	this.instance_8.setTransform(262.4,194.4,1.797,1.797,74,0,0,5,0);
	this.instance_8._off = true;

	this.instance_9 = new lib.Arrow4();
	this.instance_9.setTransform(286.4,281,1.797,1.797,74,0,0,5,0);
	this.instance_9._off = true;
	//this.instance_9.filters = [new cjs.ColorFilter(0, 0, 0, 1, 246, 128, 38, 0)];
	this.instance_9.cache(-2,-5,14,11);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(56).to({_off:false},0).to({_off:true,x:286.4,y:281},8).wait(38));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(56).to({_off:false},8).to({alpha:0},11).to({_off:true},1).wait(26));
	...
	this.instance_10.setTransform(291.5,177.1,1.797,1.797,41.6,0,0,5,0);
	this.instance_10._off = true;

	this.instance_11 = new lib.Arrow4();
	this.instance_11.setTransform(366.6,235.2,1.797,1.797,41.6,0,0,5,0);
	this.instance_11._off = true;
	//this.instance_11.filters = [new cjs.ColorFilter(0, 0, 0, 1, 246, 128, 38, 0)];
	this.instance_11.cache(-2,-5,14,11);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(56).to({_off:false},0).to({_off:true,x:366.6,y:235.2},8).wait(38));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(56).to({_off:false},8).to({alpha:0},11).to({_off:true},1).wait(26));
	...
	this.instance_12.setTransform(97.8,231.2,1.8,1.8,-30,0,0,5,0);
	...
	this.instance_13.setTransform(31.3,66.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(102));

	// Computer glow
	this.instance_14 = new lib.computer();
	this.instance_14.setTransform(61.5,265.8,0.63,0.63,0,0,0,44.7,-36.9);
	this.instance_14.shadow = new cjs.Shadow("rgba(255,102,0,1)",0,0,0);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(7).to({_off:false},0).wait(95));

	// Computer
	this.instance_15 = new lib.computer();
	this.instance_15.setTransform(179.8,313.8,0.628,0.628,0,0,0,44.6,-36.9);
	this.instance_15.shadow = new cjs.Shadow("rgba(242,98,0,1)",0,0,0);
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(84).to({_off:false},0).wait(18));

	// Laptop
	this.instance_16 = new lib.computerlaptop();
	this.instance_16.setTransform(299.6,314.4,0.628,0.628,0,0,0,53.6,-36.1);
	this.instance_16.shadow = new cjs.Shadow("rgba(242,98,0,1)",0,0,0);
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(84).to({_off:false},0).wait(18));

	// Printer
	this.instance_17 = new lib.printer();
	this.instance_17.setTransform(401.2,253.9,0.63,0.63,0,0,0,53,-22.4);
	this.instance_17.shadow = new cjs.Shadow("rgba(255,102,0,1)",0,0,0);
	this.instance_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(84).to({_off:false},0).wait(18));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(31.3,66.4,409,271);
...
(lib.animation01 = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(293.5,177.3,1.797,1.797,41.6,0,0,5,0);
	this.instance_1._off = true;

	this.instance_2 = new lib.Arrow4();
	this.instance_2.setTransform(366.6,235.2,1.797,1.797,41.6,0,0,5,0);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1}]},56).to({state:[{t:this.instance_1}]},8).to({state:[{t:this.instance_2}]},11).to({state:[]},15).wait(2));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(56).to({_off:false},0).to({x:364.6,y:233.2},8).to({_off:true,x:366.6,y:235.2,alpha:0},11).wait(17));
	...
	this.instance_3.setTransform(97.8,231.2,1.8,1.8,-30,0,0,5,0);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(24).to({_off:false},0).to({x:201.3,y:176.3},14).to({alpha:0},14).wait(40));
	...
	this.instance_4.setTransform(61.5,265.8,0.63,0.63,0,0,0,44.7,-36.9);
	this.instance_4.shadow = new cjs.Shadow("rgba(255,102,0,1)",0,0,0);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(7).to({_off:false},0).wait(85));
	...
	// Printer
	this.instance_6 = new lib.printer();
	this.instance_6.setTransform(401.2,253.9,0.63,0.63,0,0,0,53,-22.4);
	this.instance_6.shadow = new cjs.Shadow("rgba(255,102,0,1)",0,0,0);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(82).to({_off:false},0).wait(10));
...
(lib.bg_topolgy_multislide = function() {
	...
	this.instance.setTransform(-7.6,-90.4,0.799,0.799,0,0,0,50,182.1);
	this.instance.alpha = 0.109;

	this.instance_1 = new lib.bg_capsule_bluefade2();
	this.instance_1.setTransform(312.3,-205.3,0.799,0.799,0,0,0,50,182.1);
	this.instance_1.alpha = 0.078;

	this.instance_2 = new lib.bg_capsule_bluefade2();
	this.instance_2.setTransform(269.4,-12.3,0.799,0.799,0,0,0,50,182.1);
	...
	// color
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#CDEAF8","#FFFFFF"],[0,1],-65.5,-136.8,235.2,-12.6).s().p("Eg15AnEMAAAhOHMBryAAAMAAABOHg");
...
p.nominalBounds = new cjs.Rectangle(-25,-25,730,540);
...
(lib.slide_3 = function() {
	...
	this.anim03.setTransform(96.2,41);

	this.addChild(this.anim03);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(127.5,107.4,409,262);
...
(lib.slide_2 = function() {
	...
	this.anim02.setTransform(96.2,41);

	this.addChild(this.anim02);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(127.5,107.4,409,271);
...
p.nominalBounds = new cjs.Rectangle(-47.6,-350.9,752.6,958.2);


// stage content:
(lib.media_7133 = function() {
	this.initialize();
...
p.nominalBounds = new cjs.Rectangle(292.4,-105.9,752.6,958.2);
